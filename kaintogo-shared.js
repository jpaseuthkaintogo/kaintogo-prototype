...
const DEMO_ACCOUNTS = [
  {id:'u001',email:'customer'+'@'+'demo.com',password:'demo123',name:'Alex Rivera',role:'customer',avatar:'AR',ktgId:'KTG-10001',phone:'+63 917 111 0001',country:'Philippines',birthday:'1995-06-15',gender:'male',diet:'everything',homeAddress:'123 Taft Ave, Pasay',workAddress:'BGC, Taguig',savedBags:12,moneySaved:1840,co2Saved:39,favoriteShops:['s1','s3']},
  {id:'u002',email:'merchant'+'@'+'demo.com',password:'demo123',name:'Maria Santos',role:'merchant',avatar:'MS',shopId:'s1',shop:'Green Bowl'},
  {id:'u003',email:'hq'+'@'+'demo.com',password:'demo123',name:'James Kain',role:'hq',avatar:'JK'},
  {id:'u004',email:'partner'+'@'+'demo.com',password:'demo123',name:'Liza Gomez',role:'partner',avatar:'LG',org:'Feeding the Future PH',orgType:'foodbank'},
  {id:'u005',email:'admin'+'@'+'demo.com',password:'demo123',name:'KainToGo Admin',role:'admin',avatar:'KA'},
];
